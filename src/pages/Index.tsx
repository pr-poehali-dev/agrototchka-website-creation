...
const testimonials = [
  {
    ...
    company: 'КФХ "Золотое поле", Воронежская обл.',
    area: '1200 га',
    text: 'Установили автопилот на два трактора год назад. Экономия топлива реально 12-15%, перекрытия практически исчезли. Окупился за 9 месяцев. Теперь механизаторы работают даже ночью без усталости.',
    system: 'AgriDrive Pro'
  },
  {
    id: 2,
    name: 'Владимир Петрович',
    position: 'Директор',
    company: 'ООО "АгроТех", Краснодарский край',
    area: '3500 га',
    text: 'Начали с одного комбайна для теста. Увидели результат — за сезон купили ещё три системы. Точность жатки повысилась, потери зерна снизились на 20%. Рекомендую всем, кто хочет работать эффективно.',
    system: 'CombiNav Elite'
  },
  {
    id: 3,
    name: 'Анатолий Иванович',
    position: 'Главный механизатор',
    company: 'АО "Нива", Ростовская обл.',
    area: '800 га',
    text: 'Долго сомневался, но решился. Установка заняла 3 часа, настройка — полдня. Через неделю уже работал как профи. Главное — больше не устаю следить за рядами, могу сосредоточиться на качестве работы.',
    system: 'OptiSteer Basic'
  },
  {
    id: 4,
    name: 'Дмитрий Александрович',
    position: 'Руководитель',
    company: 'КФХ "Рассвет", Ставропольский край',
    area: '2200 га',
    text: 'Сначала взяли курсоуказатель для пробы. Через месяц поняли, что нужен полноценный автопилот. Разница колоссальная! Особенно при посеве — экономия семян 7-8%, ряды идеально ровные. Инвестиция себя оправдала.',
    system: 'PathGuide → AgriDrive Pro'
  }
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 text-center">
              <span className="text-sm uppercase tracking-wider text-muted-foreground font-medium">Отзывы клиентов</span>
              <h3 className="text-3xl md:text-4xl font-bold mt-2">Опыт реальных хозяйств</h3>
              <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
                Истории аграриев, которые уже используют автопилоты в своей работе
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {testimonials.map((testimonial) => (
                <Card key={testimonial.id} className="border-2 rounded-sm">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t">
                      ...
                      <span className="text-xs font-medium text-primary">{testimonial.system}</span>
                    </div>
                  </CardContent>
                </Card>
              ))}
            ...
            <div className="mt-12 text-center">
              <p className="text-sm text-muted-foreground mb-4">
                Более 2000 хозяйств доверяют нашим системам
              </p>
